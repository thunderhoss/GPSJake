 ...
 * author: mglynn
 *
 * classname: NMEAParseException
 *
 * desc: NMEAParseException provides bespoke exception for NMEA parser to allow
 * exceptions raised in NMEAParser to be handled differently.
 */

package geo;

public class NMEAParseException extends Exception {
    ...
    public NMEAParseException(String errorString, short severity) {
        super(errorString);
