 ...
 * author: mglynn
 *
 * classname: FileActionException
 *
 * desc: FileActionException provides bespoke exception for file browser classes to allow
 * exceptions raised to be handled differently.
 */
...
public class FileActionException extends Exception {
    ...
    public FileActionException(String errorString) {
        super(errorString);
    } 
}
